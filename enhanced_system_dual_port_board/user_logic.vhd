...
signal D_RAM_d_out 										:  std_logic_vector(31 downto 0); 
signal D_mem_addr                            	:  std_logic_vector(9 downto 0); 
signal D_Mre,D_Mwe                           	:  std_logic;
signal D_RAMre,D_RAMwe                         :  std_logic;
signal D_cachew0       								:  std_logic_vector(15 downto 0);
signal D_cachew1       								:  std_logic_vector(15 downto 0);
signal D_cachew2       								:  std_logic_vector(15 downto 0);
signal D_cachew3       								:  std_logic_vector(15 downto 0);
signal D_cachew4       								:  std_logic_vector(15 downto 0);
signal D_cachew5       								:  std_logic_vector(15 downto 0);
signal D_cachew6       								:  std_logic_vector(15 downto 0);
signal D_cachew7       								:  std_logic_vector(15 downto 0);
signal D_cache_hit                           	:  std_logic;
signal D_addr_b_rd, D_addr_b_wr            		:  std_logic_vector(8 downto 0);
signal D_cache_ready   								:  std_logic;
signal D_init_count 									:  std_logic_vector(1 downto 0);
signal ctrl_state 										:  std_logic_vector(7 downto 0);
signal D_PC												:  std_logic_vector(15 downto 0);
signal cache_state                             :  std_logic_vector(7 downto 0);

begin
-----------   USER DESIGN AREA    -------------- 
--a_i<=sw_vir(3 downto 0);
G0: clk_gen_1_output generic map (250,250) port map(CLOCK_50,clk);
En <= sw_vir(0);
clear <= key_vir(0);
preset <= key_vir(1);
ledr_vir_l(0) <= En;
...
A0 : SimpleCompArch port map (clk,key_vir(0),sys_output,D_rfout_bus,D_RFwa, D_RFr1a, D_RFr2a, D_RFwe, D_RFr1e, D_RFr2e, D_RFs, D_ALUs, D_PCld, D_jpz,
										D_mdout_bus,D_mdin_bus, D_RAM_d_out, D_mem_addr, D_Mre,D_Mwe, D_RAMre,D_RAMwe, D_cachew0, D_cachew1, D_cachew2, D_cachew3,
										D_cachew4, D_cachew5, D_cachew6, D_cachew7, D_cache_hit,D_addr_b_rd, D_addr_b_wr, D_cache_ready, D_init_count, ctrl_state, D_PC, cache_state,
										key_vir(1),hex0_vir_l,hex1_vir_l);
